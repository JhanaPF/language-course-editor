...
gnome-terminal --tab --title="Back-end" --working-directory="$PWD/back-end" -- "bash -c 'sudo systemctl start mongod; npm start; exec bash'"

# Lancer le deuxième terminal avec l'application 2 dans le dossier /chemin/vers/dossier2
gnome-terminal --tab --title="Dashboard" --working-directory="$PWD/dashboard" -- "bash -c 'npm start; exec bash'"
